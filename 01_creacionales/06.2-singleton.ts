...
class DatabaseConnection {
  ...
  public connect(): void {
    ...
    if (this.connected) {
      console.log('%cYa esta conectado a la base de datos', COLORS.blue);
      return;
    }

    this.connected = true;
    console.log('%cSe ha conectado a la base de datos', COLORS.green);
  }
  ...
  public disconnect(): void {
    ...
    if (this.connected) {
      ...
      console.log('%cSe ha desconectado de la base de datos', COLORS.red);
      return;
    }
